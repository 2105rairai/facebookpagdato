...
ListTile(
leading: CircleAvatar(
backgroundImage: AssetImage("assets/pictures/fandago.jpg"),
),
title: RichText(
text: TextSpan(
style: TextStyle(color: Colors.black),
...
ListTile(
leading: CircleAvatar(
backgroundImage: AssetImage("assets/pictures/9gag.jpg"),
),
title: RichText(
text: TextSpan(
style: TextStyle(color: Colors.black),
...
ListTile(
leading: CircleAvatar(
backgroundImage: AssetImage("assets/pictures/ladbible.jpg"),
),
title: RichText(
text: TextSpan(
style: TextStyle(color: Colors.black),
